...
float AbsF(const float _value);

double AbsD(const double _value);

long double AbsLD(const long double _value);

float AcosF(const float _value);

double AcosD(const double _value);

long double AcosLD(const long double _value);

float AcoshF(const float _value);

double AcoshD(const double _value);

long double AcoshLD(const long double _value);

float AsinF(const float _value);

double AsinD(const double _value);

long double AsinLD(const long double _value);

float AsinhF(const float _value);

double AsinhD(const double _value);

long double AsinhLD(const long double _value);

float AtanF(const float _value);

double AtanD(const double _value);

long double AtanLD(const long double _value);

float Atan2F(const float _left, const float _right);

double Atan2D(const double _left, const double _right);

long double Atan2LD(const long double _left, const long double _right);

float AtanhF(const float _value);

double AtanhD(const double _value);

long double AtanhLD(const long double _value);

float CbrtF(const float _value);

double CbrtD(const double _value);

long double CbrtLD(const long double _value);

float CeilF(const float _value);

double CeilD(const double _value);

long double CeilLD(const long double _value);

int32_t ClampI(const int32_t _value, const int32_t _min, const int32_t _max);

uint32_t ClampUI(const uint32_t _value, const uint32_t _min, const uint32_t _max);

int64_t ClampL(const int64_t _value, const int64_t _min, const int64_t _max);

uint64_t ClampUL(const uint64_t _value, const uint64_t _min, const uint64_t _max);

float ClampF(const float _value, const float _min, const float _max);

double ClampD(const double _value, const double _min, const double _max);

long double ClampLD(const long double _value, const long double _min, const long double _max);

float Clamp01F(const float _value);

double Clamp01D(const double _value);

long double Clamp01LD(const long double _value);

float CosF(const float _value);

double CosD(const double _value);

long double CosLD(const long double _value);

float CoshF(const float _value);

double CoshD(const double _value);

long double CoshLD(const long double _value);

float ExpF(const float _value);

double ExpD(const double _value);

long double ExpLD(const long double _value);

float FloorF(const float _value);

double FloorD(const double _value);

long double FloorLD(const long double _value);

float LogF(const float _value);

double LogD(const double _value);

long double LogLD(const long double _value);

float Log10F(const float _value);

double Log10D(const double _value);

long double Log10LD(const long double _value);

float Log2F(const float _value);

double Log2D(const double _value);

long double Log2LD(const long double _value);

int32_t MaxI(const int32_t _left, const int32_t _right);

uint32_t MaxUI(const uint32_t _left, const uint32_t _right);

int64_t MaxL(const int64_t _left, const int64_t _right);

uint64_t MaxUL(const uint64_t _left, const uint64_t _right);

float MaxF(const float _left, const float _right);

double MaxD(const double _left, const double _right);

long double MaxLD(const long double _left, const long double _right);

int32_t MinI(const int32_t _left, const int32_t _right);

uint32_t MinUI(const uint32_t _left, const uint32_t _right);

int64_t MinL(const int64_t _left, const int64_t _right);

uint64_t MinUL(const uint64_t _left, const uint64_t _right);

float MinF(const float _left, const float _right);

double MinD(const double _left, const double _right);

long double MinLD(const long double _left, const long double _right);

float PowF(const float _left, const float _right);

double PowD(const double _left, const double _right);

long double PowLD(const long double _left, const long double _right);

float RoundF(const float _value);

double RoundD(const double _value);

long double RoundLD(const long double _value);

int32_t SignF(const float _value);

int32_t SignD(const double _value);

int32_t SignLD(const long double _value);

float SinF(const float _value);

double SinD(const double _value);

long double SinLD(const long double _value);

float SinhF(const float _value);

double SinhD(const double _value);

long double SinhLD(const long double _value);

float SqrtF(const float _value);

double SqrtD(const double _value);

long double SqrtLD(const long double _value);

float TanF(const float _value);

double TanD(const double _value);

long double TanLD(const long double _value);

float TanhF(const float _value);

double TanhD(const double _value);

long double TanhLD(const long double _value);
