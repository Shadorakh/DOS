...
Tuple3F Vector3F_AddScalar(const Vector3F* const _left, const size_t _leftIndex,
...
float Vector3F_AngleScalar(const Vector3F* const _from, const size_t _fromIndex,
	                       const Vector3F* const _to, const size_t _toIndex);

Tuple3F Vector3F_BackScalar(void);
...
void Vector3F_CopyScalar(const Vector3F* const _from, const size_t _fromIndex,
...
Tuple3F Vector3F_CrossScalar(const Vector3F* const _left, const size_t _leftIndex,
	                         const Vector3F* const _right, const size_t _rightIndex);
...
float Vector3F_DistanceScalar(const Vector3F* const _from, const size_t _fromIndex,
	                          const Vector3F* const _to, const size_t _toIndex);
...
float Vector3F_DistanceSquaredScalar(const Vector3F* const _from, const size_t _leftIndex,
...
Tuple3F Vector3F_DivideScalar(const Vector3F* const _left, const size_t _leftIndex,
	                          const Vector3F* const _right, const size_t _rightIndex);
...
float Vector3F_DotScalar(const Vector3F* const _left, const size_t _leftIndex,
	                     const Vector3F* const _right, const size_t _rightIndex);

Tuple3F Vector3F_DownScalar(void);

bool Vector3F_Equals(const Vector3F* const _left, const size_t _leftIndex,
	                 const Vector3F* const _right, const size_t _rightIndex);

Tuple3F Vector3F_ForwardScalar(void);

Tuple3F Vector3F_Get(const Vector3F* const _vector, const size_t _index);

bool Vector3F_IsNull(const Vector3F* const _vector);

Tuple3F Vector3F_LeftScalar(void);
...
float Vector3F_LengthScalar(const Vector3F* const _vector, const size_t _index);

void Vector3F_LengthSquared(ArrayF* const _result, const size_t _resultIndex,
	                        const Vector3F* const _vector, const size_t _vectorIndex, const size_t _count);

float Vector3F_LengthSquaredScalar(const Vector3F* const _vector, const size_t _index);
...
Tuple3F Vector3F_LerpScalar(const Vector3F* const _left, const size_t _leftIndex,
	                        const Vector3F* const _right, const size_t _rightIndex,
...
Tuple3F Vector3F_LerpUnclampedScalar(const Vector3F* const _left, const size_t _leftIndex,
	                                 const Vector3F* const _right, const size_t _rightIndex,
	                                 const ArrayF* const _interpolationFactor, const size_t _interpolationFactorIndex);
...
Tuple3F Vector3F_MaxScalar(const Vector3F* const _left, const size_t _leftIndex,
	                       const Vector3F* const _right, const size_t _rightIndex);
...
Tuple3F Vector3F_MinScalar(const Vector3F* const _left, const size_t _leftIndex,
	                       const Vector3F* const _right, const size_t _rightIndex);
...
Tuple3F Vector3F_MoveTowardsScalar(const Vector3F* const _current, const size_t _currentIndex,
	                               const Vector3F* const _target, const size_t _targetIndex,
...
Tuple3F Vector3F_MultiplyScalar(const Vector3F* const _left, const size_t _leftIndex,
	                            const Vector3F* const _right, const size_t _rightIndex);

void Vector3F_Normalize(Vector3F* const _vector, const size_t _index, const size_t _count);

void Vector3F_NormalizeScalar(Vector3F* const _vector, const size_t _index);

Tuple3F Vector3F_OneScalar(void);
...
Tuple3F Vector3F_ProjectScalar(const Vector3F* const _vector, const size_t _vectorIndex,
...
Tuple3F Vector3F_ProjectOnPlaneScalar(const Vector3F* const _vector, const size_t _vectorIndex,
...
Tuple3F Vector3F_ReflectScalar(const Vector3F* const _inDirection, const size_t _inDirectionIndex,
	                           const Vector3F* const _inNormal, const size_t _inNormalIndex);

Tuple3F Vector3F_RightScalar(void);

void Vector3F_Set(Vector3F* const _vector, const size_t _index, const Tuple3F _value);

void Vector3F_SignedAngle(ArrayF* const _result, const size_t _resultIndex,
	                      const Vector3F* const _from, const size_t _fromIndex,
	                      const Vector3F* const _to, const size_t _toIndex, const size_t _count);

float Vector3F_SignedAngleScalar(const Vector3F* const _from, const size_t _fromIndex,
	                             const Vector3F* const _to, const size_t _toIndex);
...
Tuple3F Vector3F_SmoothDampScalar(const Vector3F* const _current, const size_t _currentIndex,
	                              const Vector3F* const _target, const size_t _targetIndex,
	                              Vector3F* const _currentVelocity, const size_t _currentVelocityIndex,
	                              const ArrayF* const _smoothTime, const size_t _smoothTimeIndex,
	                              const ArrayF* const _maxSpeed, const size_t _maxSpeedIndex,
...
Tuple3F Vector3F_SubtractScalar(const Vector3F* const _left, const size_t _leftIndex,
	                            const Vector3F* const _right, const size_t _rightIndex);

void Vector3F_ToString(char* _result, const size_t _resultSize, const Vector3F* const _vector, const size_t _index);

Tuple3F Vector3F_UpScalar(void);

Tuple3F Vector3F_ZeroScalar(void);
	                                  ...
	                                  const Vector3F* const _onNormal, const size_t _onNormalIndex) 
{
	...
	{
		const dot = Vector3F_DotScalar(_vector, _vectorIndex, _onNormal, _onNormalIndex);
	                                         ...
	                                         const Vector3F* const _planeNormal, const size_t _planeNormalIndex)
{
	...
	{
		const dot = Vector3F_DotScalar(_vector, _vectorIndex, _planeNormal, _planeNormalIndex);
